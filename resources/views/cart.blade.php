                                            ...
                                            @if (session()->has('order'))
                                                @foreach ($meals as $meal)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a style="color: black" href="{{ route('restaurants.show', $restaurant->id) }}" class="text-decoration-none">
                                                                {{ $meal->name }}
                                                            </a>
                                                        </td>
                                                        <td>
			 			...
			 			<div class="col-md-12 col-lg-4">
			 				<div class="summary">
                                 ...
                                 <form action="{{ route('checkout') }}" method="POST">
                                    @csrf
			 					<div class="summary-item"><span class="text">Subtotal</span><span class="price">     @if ($price !== 0)
                                    ${{ $price }}
                                @else
                                    0
                                @endif</span></div>
			 					<div class="summary-item"><span class="text">Delivery fee</span><span class="price">                                    @if ($price !== 0)
                                    <bdi>${{ $restaurant->delivery_fee }}</bdi>
                                @else
                                    0
                                @endif
</span></div>
			 					<div class="summary-item"><span class="text">Total</span><span class="price">                                    @if ($price !== 0)
...
<div class="summary-item"><br><span class="text">Note :<textarea class="form-control" placeholder="" id="floatingTextarea3"  name="address" required></textarea>
                                 </span><span class="price">
                                </span><br></div>
<div class="summary-item"><br><span class="text">Address :<textarea class="form-control" placeholder="" id="floatingTextarea2" name="note"></textarea>
</span><span class="price"> </span><br></div>
...
<tr>
    <td colspan="2">
        ...
        <div class="d-grid gap-2">
            <button class="btn btn-lg " style="background-color:#fec45b" type="submit" role="button">
                Checkout
            </button>
        </div>
    </td>
...
<tr>
    <td colspan="2">
        <div class="d-grid gap-2">
            <button class="btn btn-lg " style="background-color:#fec45b" type="submit" role="button" disabled>
                checkout
            </button>
        </div>
    </td>
